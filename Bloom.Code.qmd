...
dc <- read.table('C:/Users/david/Desktop/GMU Files/2024 Spring/Capstone/Bloom/washingtondc.csv', sep=',', header=TRUE)
liestal <- read.table('C:/Users/david/Desktop/GMU Files/2024 Spring/Capstone/Bloom/liestal.csv', sep=',', header=TRUE)
kyoto <- read.table('C:/Users/david/Desktop/GMU Files/2024 Spring/Capstone/Bloom/kyoto.csv', sep=',', header=TRUE)
vancouver <- read.table('C:/Users/david/Desktop/GMU Files/2024 Spring/Capstone/Bloom/vancouver.csv', sep=',', header=TRUE)
...
###############################################
#Format and add temp to Vancouver dataframe
###############################################

#Vancouver Average Temperatures by Month since 2010
vancouver_jan <- c(6,4,3,3,5,6,5,1,5,5,4,5,4,5)
vancouver_feb <- c(7,3,5,4,2,8,7,3,3,1,5,3,5,4)


# Filter the overall data to create a dataframe of recent Liestal bloom DOY data
vancouver_recent <- liestal[liestal$year >= 2010,]

# Add average temperature to dataframe
vancouver_recent$jan_avg <- vancouver_jan
vancouver_recent$feb_avg <- vancouver_feb
